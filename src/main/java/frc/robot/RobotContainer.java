...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    joystickAButton
        .onTrue(new InstantCommand(() -> m_arm.setAngle(75.0), m_arm))
  ...
  public double getthrottle(){
    double controller=-m_controller.getRawAxis(1);
    if(m_sensors.getDistanceinches()<6.0 && controller>0){
      controller=0;
    } 
    return controller;
  }
  ...
  public Command getArcadeDriveCommand() {
    return new ArcadeDrive(
        m_drivetrain, () -> getthrottle() , () -> -m_controller.getRawAxis(2));
  }
}
