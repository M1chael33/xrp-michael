...
public class Drivetrain extends SubsystemBase {
  ...
  private double m_leftDistance = getLeftDistanceInch();
  private double m_rightDistance = getRightDistanceInch();
  ...
  public double getLeftRate() {
    double rate = (getLeftDistanceInch() - m_leftDistance )/ .02 ;
    m_leftDistance = getLeftDistanceInch();
    return rate;
  }

  public double getRightRate() {
    double rate = (getRightDistanceInch() - m_leftDistance) / .02 ;
    m_leftDistance = getRightDistanceInch();
    return rate;
  }
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber(" getGyroX  ", getGyroAngleX());
